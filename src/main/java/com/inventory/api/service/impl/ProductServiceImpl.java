...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO decreaseInventory(Long id, Integer quantity) {
        ...
        int newQuantity = product.getInventoryQuantity() - quantity;
        if (newQuantity < 0) {
            throw new InsufficientInventoryException("Cannot decrease inventory below zero. Current inventory: "
                    + product.getInventoryQuantity() + ", Requested decrease: " + quantity);
        }
